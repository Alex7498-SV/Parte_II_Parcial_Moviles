...
--7. Agregar una columna a la tabla LIBRO llamada precioDescuento de tipo MONEY (7%)
--EJERCICIO:
 
--8. Eliminar la columna creada en el punto anterior. (5%)
--EJERCICIO:
 
--9. Agregar una columna a la tabla LIBRO llamada precioDescuento de tipo MONEY que tenga la restricción NOT NULL. (10%)
--EJERCICIO:
 
--10. Actualizar la columna reciente creada en el punto anterior con el precio menos un 25% de descuento de todos los libros que tenga un precio mayor de $50.  (10%)
--EJERCICIO:
 
--11. Agregar una columna llamada coordinador a la tabla empleado. (5%)
--EJERCICIO:
 
--12. Actualizar el campo recién creado con el valor de 1 para todos los empleados cuyo idEmpleado sea mayor a 2 y menor a 7. (10%)
--EJERCICIO:
 
--13. Utilice self join para mostrar la lista de empleados y el nombre de su coordinador respectivo si es que tiene. (11%)
--EJERCICIO:
